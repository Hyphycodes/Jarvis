...
const PLACE_RE = /\b(hotel|inn|lobby|park|trail|lakefront|riverwalk|waterfront|beach|garden|neighborhood|scenic|view|bookstore|book shop|cigar lounge|cigar room|cigar|spa|plaza|promenade|lookout|observatory)\b/i;
const CULTURE_RE = /\b(museum|gallery|exhibit|exhibition|architecture|architectural|design|film|cinema|craftsmanship|opera|theater|theatre|fine arts|cultural center|biennial|art institute|installation|screening|artist|jazz archive)\b/i;
